...
var _formatReader = require('./utils/formatReader');
...
var Lightbox = function (_Component) {
	...
	_createClass(Lightbox, [{
		...
		value: function renderImages() {
			...
			var sourceSet = null;
			if ((0, _formatReader.isImage)(image)) {
			...
			return _react2.default.createElement(
				...
				(0, _formatReader.isImage)(image) && _react2.default.createElement('img', {
					key: currentImage,
				...
				(0, _formatReader.isVideo)(image) && _react2.default.createElement(
					'video',
					{
						key: currentImage,
						controls: true,
					...
					_react2.default.createElement('source', { src: image.src, type: (0, _formatReader.getType)(image) })
				)
			);
		}
	}, {
